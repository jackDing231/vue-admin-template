...
import departmentRouter from './modules/department' // 部门管理
import approvalRouter from './modules/approval' // 考勤管理
import attendanceRouter from './modules/attendance' // 组织架构
...
export const constantRoutes = [
  ...
  departmentRouter, // 部门管理

  approvalRouter, // 考勤管理

  attendanceRouter, // 组织架构
